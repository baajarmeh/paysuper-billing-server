...
func (suite *DashboardRepositoryTestSuite) Test_GetDashboardCustomerReport_Ok() {
	...
	shouldBe.NotNil(report.Arppu)
	shouldBe.NotNil(report.Arppu.Current)
	shouldBe.NotZero(report.Arppu.Current.Amount)
	shouldBe.NotEmpty(report.Arppu.Current.Currency)
