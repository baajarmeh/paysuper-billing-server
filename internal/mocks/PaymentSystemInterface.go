...
func (_m *PaymentSystemInterface) CreateRecurringSubscription(order *billingpb.Order, subscription *billingpb.RecurringSubscription, successUrl string, failUrl string, requisites map[string]string) (string, error) {
	ret := _m.Called(order, subscription, successUrl, failUrl, requisites)

	var r0 string
	if rf, ok := ret.Get(0).(func(*billingpb.Order, *billingpb.RecurringSubscription, string, string, map[string]string) string); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*billingpb.Order, *billingpb.RecurringSubscription, string, string, map[string]string) error); ok {
...
func (_m *PaymentSystemInterface) DeleteRecurringSubscription(order *billingpb.Order, subscription *billingpb.RecurringSubscription) error {
	ret := _m.Called(order, subscription)

	var r0 error
	if rf, ok := ret.Get(0).(func(*billingpb.Order, *billingpb.RecurringSubscription) error); ok {
