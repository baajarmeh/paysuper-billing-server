...
require (
	...
	github.com/paysuper/paysuper-proto/go/billingpb v0.0.0-20210210135503-ff94d410a3f9
	...
	github.com/paysuper/paysuper-proto/go/recurringpb v0.0.0-20210208211649-aa38ed8d6095
